...
/**
 * The primary key class for the interface_ip database table.
 * 
 */
@Embeddable
public class InterfaceIpPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof InterfaceIpPK)) {
			return false;
		}
		InterfaceIpPK castOther = (InterfaceIpPK)other;
		return 
