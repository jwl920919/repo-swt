...
public class IPv6NetworkHelpers
{
    ...
    {
        final BitSet firstBits = BitSetHelpers.bitSetOf(first.getLowBits(), first.getHighBits());
        final BitSet lastBits = BitSetHelpers.bitSetOf(last.getLowBits(), last.getHighBits());
