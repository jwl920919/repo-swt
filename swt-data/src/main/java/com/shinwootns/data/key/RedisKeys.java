...
public class RedisKeys {
	...
	// Insight Cluster
	public final static String KEY_INSIGHT_CLUSTER_MASTER	= "cluster:insight:master";
	public final static String KEY_INSIGHT_CLUSTER_MEMBER	= "cluster:insight:member:";		// ~:{HostName}
	public final static String KEY_INSIGHT_CLUSTER_JOB		= "cluster:insight:job:";			// ~:{HostName}
}
