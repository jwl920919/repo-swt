    ...
    var P = function(h) {
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                oPaginate: {
                    sFirst: getLanguage("first"),
                    sLast: getLanguage("last"),
                    sNext: getLanguage("next"),
                    sPrevious: getLanguage("previous")
                },
                sEmptyTable: getLanguage("nodataavailableintable"), //"No data available in table",
                ...
                sDecimal: "",
                sThousands: ",",
                sLengthMenu: "_MENU_ ", //sLengthMenu: "Show _MENU_ entries",
                sLoadingRecords: getLanguage("loading"), //"Loading...",
                sProcessing: getLanguage("processing"), //"Processing...",
                sSearch: getLanguage("search") + " : ", //"Search:",
                sSearchPlaceholder: "",
                sUrl: "",
