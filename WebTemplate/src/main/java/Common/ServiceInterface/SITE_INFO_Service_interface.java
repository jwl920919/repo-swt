...
public interface SITE_INFO_Service_interface {
	public List<Common.DTO.SITE_INFO_DTO> select_SITE_INFO();
	public Common.DTO.SITE_INFO_DTO select_SITE_INFO_ONE_SEARCH(HashMap<String, Object> parameters);
	public List<Common.DTO.SITE_INFO_DTO> select_SITE_INFO_CONDITIONAL_SEARCH(HashMap<String, Object> parameters);
