...
public class Subnet {
	...
	public Subnet(String networkIp, final int bits) throws UnknownHostException {
		
		InetAddress subnetAddress = InetAddress.getByName(networkIp);
	...
	public Subnet(String networkIp, String netmask) throws UnknownHostException {
	...
	static private void bigInteger2IpString(final StringBuilder buf, final BigInteger bigInteger,
