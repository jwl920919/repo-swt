...
public class IP_MANAGEMENT_Impl extends SqlSessionDaoSupport implements IP_MANAGEMENT_Interface{
	 ...
	 * </p> 
	 **/
	public List<Map<String, Object>> select_IP_MANAGEMENT_BLACKLIST_STATUS_DATA(HashMap<String, Object> parameters) {
		// TODO Auto-generated method stub
		List<Map<String, Object>> select_IP_MANAGEMENT_BLACKLIST_STATUS_DATA = new ArrayList<Map<String, Object>>();
		try {
			System.out.println("select_IP_MANAGEMENT_BLACKLIST_STATUS_DATA : " + getSqlSession());
			select_IP_MANAGEMENT_BLACKLIST_STATUS_DATA = getSqlSession().selectList("UI_Query.select_IP_MANAGEMENT_BLACKLIST_STATUS_DATA", parameters);
		} catch (Exception e) {
			// TODO: handle exception
			System.out.println(e.getMessage());
		}
		return select_IP_MANAGEMENT_BLACKLIST_STATUS_DATA;
	}
