...
<div id="content-tree" class="tree-warper">
...
<div id="content-tree-line" class="tree-warper"></div>
<div id="content-tree-wrapper" class="tree-warper">
	<div id="depth-title" style="margin-top: 2px;margin-bottom: 1px;">
		<table>
			<tr>
	...
	<div class="hidden" id="defaultDiv">
		<div>
			<table>
				<tr>
					<td><label
					...
					<td><select id="deviceSel"
						class="form-control selectoption_grey_color" style="width: 210px">
					</select></td>
					<td><input type="text"
