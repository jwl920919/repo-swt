...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<a href="/main" class="logo" > <!-- mini logo for sidebar mini 50x50 pixels -->
			<span class="logo-mini"><div style="margin-top: 15px; margin-left: 7px;" class="glyphicon glyphicon-forward"></div></span> <!-- logo for regular state and mobile devices -->
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-files-o"></i>
					...
					lass="label label-primary pull-right">40</span>
			</a>
				<ul class="treeview-menu">
			...
			<div class="row">
				...
				<div class="box box-solid bg-light-blue-gradient">
					...
					<div class="box-footer no-border">
						<div class="row">
							<div class="col-xs-4 text-center"
								style="border-right-width: 1px; border-right-color: rgb(244, 244, 244); border-right-style: solid;">
